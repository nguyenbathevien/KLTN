...
const Verify = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-red-500 to-blue-600 text-white py-4 px-6 rounded-lg w-full text-lg  transition shadow-md">
